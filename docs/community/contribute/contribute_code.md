...
To understand how the below components interact with each other, refer
to
`Understand the lifecycle of a workflow <workflow-lifecycle>`{.interpreted-text
role="ref"}.
...
With the exception of `flytekit`, the below components are maintained in
the [flyte](https://github.com/flyteorg/flyte) monorepo.
::::

<figure class="align-center">
<img
src="https://raw.githubusercontent.com/flyteorg/static-resources/main/flyte/contribution_guide/dependency_graph.png"
alt="https://raw.githubusercontent.com/flyteorg/static-resources/main/flyte/contribution_guide/dependency_graph.png" />
<figcaption>The dependency graph between various flyte
repos</figcaption>
</figure>
...
+----------------------------------------------------------------------+
| [Repo](https://github.com/flyteorg/flytepropeller) \| [Code          |
| R                                                                    |
| eference](https://pkg.go.dev/mod/github.com/flyteorg/flytepropeller) |
+----------------------------------------------------------------------+
...
+----------------------------------------------------------------------+
| [Repo](https://github.com/flyteorg/flyteadmin) \| [Code              |
| Reference](https://pkg.go.dev/mod/github.com/flyteorg/flyteadmin)    |
+----------------------------------------------------------------------+
...
|                                                                      |
|   :   - `make integration`                                           |
|       - (or to run in containerized dockernetes):                    |
|         `make k8s_integration`                                       |
+----------------------------------------------------------------------+
...
+----------------------------------------------------------------------+
| [Repo](https://github.com/flyteorg/flyteplugins) \| [Code            |
| Reference](https://pkg.go.dev/mod/github.com/flyteorg/flyteplugins)  |
+----------------------------------------------------------------------+
